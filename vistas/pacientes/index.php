...
<div class="container mt-5" style="max-width: 700px; background-color: #2471A3; border: solid 2px; border-color: #fff; border-radius: 2px" >
        <h1 class="text-center mb-4" style="font-family:'Courier New', Courier, monospace"> FORMULARIO INGRESAR PACIENTES</h1>
        <div class="row justify-content-center">
            <form action="/hospital_final_jimenez/controladores/pacientes/guardar.php" method="POST" class="col-lg-6 border p-4 rounded mb-4" style="font-family:'Courier New', Courier, monospace; background-color:#AAB7B8;">
                <div class="row mb-3">
                    <div class="col">
