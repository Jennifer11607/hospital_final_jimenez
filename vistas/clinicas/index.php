...
<?php include_once '../../includes/navbar.php'?>
        ...
        <h1 class="text-center"style="font-family:'Courier New', Courier, monospace">FORMULARIO DE INGRESO CLINICAS</h1>
        <div class="row justify-content-center">
            <form action="/hospital_final_jimenez/controladores/clinicas/guardar.php" method="POST" class="col-lg-8 border p-3 mb-4" style="font-family:'Courier New', Courier, monospace; background-color:#AAB7B8;">
                <div class="row mb-3">
                    <div class="col">
